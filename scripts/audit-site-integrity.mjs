...
const photoOnlyEditorialGuides={
  "guides/howe-caverns-with-kids.html":"howe-caverns.webp",
  "guides/family-binoculars-8x-vs-10x.html":"family-binoculars.webp",
  "guides/family-lost-kid-plan.html":"family-lost-kid-plan.webp",
  "guides/montezuma-national-wildlife-refuge-with-kids.html":"montezuma-refuge.webp",
  "guides/family-travel-games-guide.html":"family-travel-games.webp",
  "guides/family-motion-sickness-car-plan.html":"family-motion-sickness-plan.webp",
  ...
  ,"guides/pratts-falls-with-kids.html":"pratts-falls.webp"
  ,"guides/family-roof-cargo-box-bag-basket-guide.html":"family-roof-cargo-options.webp"
  ,"guides/multigenerational-family-day-trip-plan.html":"multigenerational-family-day-trip.webp"
  ,"guides/fort-stanwix-with-kids.html":"fort-stanwix-national-monument.webp"
  ,"guides/kids-hiking-footwear-trail-runner-shoe-boot.html":"kids-hiking-footwear-categories.webp"
  ,"guides/family-no-cell-service-day-trip-plan.html":"family-no-cell-service-plan.webp"
  ,"guides/harriet-tubman-national-historical-park-with-kids.html":"harriet-tubman-church-auburn.webp"
  ,"guides/kids-bike-helmet-fit-certification-guide.html":"kids-bicycle-helmet-fit.webp"
  ,"guides/family-tick-check-removal-plan.html":"family-tick-check-plan.webp"
  ,"guides/womens-rights-national-historical-park-with-kids.html":"womens-rights-history-day.webp"
  ,"guides/family-car-jump-starter-lithium-jump-box-cables-guide.html":"family-jump-starter-options.webp"
  ,"guides/family-hotel-fire-escape-plan.html":"family-hotel-fire-escape-plan.webp"
  ,"guides/buttermilk-falls-state-park-with-kids.html":"buttermilk-falls-state-park.webp"
  ,"guides/kids-booster-seat-high-back-backless-harness-guide.html":"kids-booster-seat-categories.webp"
...
if(htmlFiles.length!==94)fail("expected 94 HTML pages, found "+htmlFiles.length);
...
for(const [rel,photo] of Object.entries(photoOnlyEditorialGuides)){
  const html=readFileSync(resolve(root,rel),"utf8");
  const hero='class="article-hero" src="../assets/images/photos/'+photo+'"';
  if(!html.includes(hero))fail(rel+": verified editorial photograph is not the article hero");
  if(count(html,/class="article-hero"/g)!==1)fail(rel+": must contain exactly one article hero");
  if(count(html,/class="article-plan"/g)!==0)fail(rel+": chart or planning diagram must not replace or duplicate the hero photograph");
}
const sitemap=readFileSync(resolve(root,"sitemap.xml"),"utf8");
const sitemapUrls=[...sitemap.matchAll(/<loc>(.*?)<\/loc>/g)].map(match=>match[1]);
if(sitemapUrls.length!==94)fail("expected 94 sitemap URLs, found "+sitemapUrls.length);
