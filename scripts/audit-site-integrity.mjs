...
if(htmlFiles.length!==84)fail("expected 84 HTML pages, found "+htmlFiles.length);
...
if(sitemapUrls.length!==84)fail("expected 84 sitemap URLs, found "+sitemapUrls.length);
