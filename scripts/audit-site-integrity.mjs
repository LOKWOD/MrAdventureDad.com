...
if(htmlFiles.length!==87)fail("expected 87 HTML pages, found "+htmlFiles.length);
...
if(sitemapUrls.length!==87)fail("expected 87 sitemap URLs, found "+sitemapUrls.length);
