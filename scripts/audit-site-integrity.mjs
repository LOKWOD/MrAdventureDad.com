...
if(htmlFiles.length!==81)fail("expected 81 HTML pages, found "+htmlFiles.length);
...
if(sitemapUrls.length!==81)fail("expected 81 sitemap URLs, found "+sitemapUrls.length);
