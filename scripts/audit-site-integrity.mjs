...
if(htmlFiles.length!==56)fail("expected 56 HTML pages, found "+htmlFiles.length);
...
if(sitemapUrls.length!==56)fail("expected 56 sitemap URLs, found "+sitemapUrls.length);
